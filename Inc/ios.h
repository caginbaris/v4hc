...
extern union digitalInputUnion uDI;



struct digitalOutputs{
	
	uint8_t CTB1_READY:1;		// DO-1
	uint8_t CTB1_RUN:1;			// DO-2
	uint8_t CTB1_IBF:1;			// DO-2
	uint8_t CTB1_SPARE:1;		// DO-2
